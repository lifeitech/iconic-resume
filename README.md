...
- All resume contents are placed in [_config.yml](/_config.yml);
- All resume styles are defined in [style.scss](/style.scss). 

You can view the resume in PDF format [here](/resume.pdf).
